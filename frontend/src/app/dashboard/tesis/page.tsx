          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-10">
              <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                <div className="space-y-1">
                  <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Trabajos Especiales de Grado</h2>
                  <p className="text-gray-500 font-medium">Revisa y gestiona las tesis del período académico actual.</p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2.5 px-4 py-2.5 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-100/50 shadow-sm">
                      <div className="relative">
                        <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
                        <div className="absolute inset-0 w-2.5 h-2.5 rounded-full bg-emerald-500/50 animate-ping" />
                      </div>
                      <span className="text-sm font-bold text-emerald-700">
                        {semesterProjects.length} {semesterProjects.length === 1 ? 'Tesis' : 'Tesis'}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="section-container mb-12">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 tracking-tight">Tesis Revisadas</h3>
                        <p className="text-sm text-gray-500 font-medium">Tesis que ya cuentan con una calificación definitiva.</p>
                      </div>
                    </div>
                    <div className="px-4 py-1.5 bg-emerald-50 rounded-full border border-emerald-100/50 self-start sm:self-center">
                      <span className="text-sm font-bold text-emerald-700">
                        {checkedProjects.length} {checkedProjects.length === 1 ? 'tesis' : 'tesis'}
                      </span>
                    </div>
                  </div>
                ...
                <div className="section-container mb-12">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 tracking-tight">Tesis Pendientes</h3>
                        <p className="text-sm text-gray-500 font-medium">Tesis que requieren evaluación por parte del jurado.</p>
                      </div>
                    </div>
                    <div className="px-4 py-1.5 bg-amber-50 rounded-full border border-amber-100/50 self-start sm:self-center">
                      <span className="text-sm font-bold text-amber-700">
                        {pendingProjects.length} {pendingProjects.length === 1 ? 'tesis' : 'tesis'}
                      </span>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                ...
                <div className="section-container mb-12">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 tracking-tight">Tesis Rechazadas</h3>
                        <p className="text-sm text-gray-500 font-medium">Tesis que han sido devueltas por observaciones críticas.</p>
                      </div>
                    </div>
                    <div className="px-4 py-1.5 bg-red-50 rounded-full border border-red-100/50 self-start sm:self-center">
                      <span className="text-sm font-bold text-red-700">
                        {rejectedProjects.length} {rejectedProjects.length === 1 ? 'tesis' : 'tesis'}
                      </span>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            {isDataLoaded && filteredProjects.length === 0 && (
              <div className="bg-white/40 backdrop-blur-sm rounded-[2.5rem] border border-dashed border-gray-300 py-20 text-center relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-emerald-50/50 rounded-full blur-3xl -z-10" />
                ...
                <p className="text-gray-500 font-medium max-w-sm mx-auto">
                  No hay trabajos especiales de grado que coincidan con la búsqueda o filtros actuales.
                </p>
                <button 
