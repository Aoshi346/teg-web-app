  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-[14px] bg-gradient-to-br from-[rgba(0,102,255,0.08)] to-[rgba(255,107,53,0.08)] text-primary inline-flex items-center justify-center mb-3.5">
        <Lock className="w-[26px] h-[26px]" />
      </div>
      <h2 id="security-heading" className="text-lg font-extrabold text-text-strong tracking-tight mb-1.5">
        Seguridad
      </h2>
      <p className="text-[13.5px] text-text-muted max-w-[48ch] mx-auto mb-4 leading-[1.55]">
        La gestión de contraseña y sesiones llegará en la próxima fase. Por ahora, contacta al administrador para cambios de contraseña.
      </p>
