...
/**
 * Componente Bell que encapsula el botón, la insignia de no leídas y el panel dropdown.
 * Consume `useNotifications()` directamente para ser auto-suficiente en DashboardHeader.
 */
export function NotificationBell() {
  const [isOpen, setIsOpen] = useState(false);
  const { notifications, unreadCount, openDropdown, markRead, markAllRead } =
    useNotifications();
