...
export default function Footer() {
  return (
    <>
      {/* CTA Banner */}
      <section className="relative bg-gradient-to-br from-usm-navy via-usm-navy to-blue-900 py-20 px-4 overflow-hidden">
        ...
        <div className="relative container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-slate-300 mb-8 max-w-xl mx-auto">
            Simplifica la gestión de tu Trabajo Especial de Grado con una herramienta diseñada para ti.
          </p>
          <button
            onClick={() => {
              const btn = document.querySelector('[aria-label="Ingresar"]') as HTMLButtonElement;
              if (btn) btn.click();
            }}
      ...
      <footer className="bg-gray-950 text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              <h4 className="font-semibold text-sm uppercase tracking-wider text-gray-300">Enlaces</h4>
            ...
            <div>
              <h4 className="font-semibold text-sm uppercase tracking-wider text-gray-300">Dirección</h4>
            ...
            <div>
              <h4 className="font-semibold text-sm uppercase tracking-wider text-gray-300">Síguenos</h4>
              <div className="mt-4 flex space-x-4">
                <a
                  href="#"
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 border border-white/10
                           text-gray-400 transition-all hover:text-usm-blue hover:bg-usm-blue/10 hover:border-usm-blue/30"
