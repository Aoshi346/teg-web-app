...
import { X, Mail, Shield, User, Phone, BookOpen, ChevronDown, ChevronRight } from "lucide-react";
            ...
            <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 transform transition-all animate-in zoom-in-95 fade-in duration-200 overflow-hidden">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-blue-100 text-sm">
                                {initialData ? "Modifica la información del usuario" : "Completa los datos para crear un usuario"}
                            </p>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 bg-gray-50/50">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5 block">Nombre Completo</label>
                        ...
                        <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5 block">Correo Electrónico</label>
                            <div className="relative">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                        <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5 block">Teléfono</label>
                            <div className="relative">
                        ...
                        <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5 block">Semestre</label>
                            <div className="relative">
                        ...
                        <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5 block">Rol</label>
                            <div className="relative">
