...
export const QUESTIONS: Question[] = [
  ...
  // Diagramacion - General aggregated checks for Proyecto
  { id: "q70", label: "D.1 - Elementos preliminares (Proyecto)", helper: "¿El documento cuenta con portada, página de presentación, carta de aprobación del tutor (firmada), declaración de derecho de autor, índice general, índices específicos (si aplica), lista de símbolos y abreviaturas (si aplica) y glosario de términos (si aplica)?", section: "Diagramacion", subsection: "General", documentType: 'Proyecto', answerType: 'yesno' },
  { id: "q71", label: "D.2 - Formato en la totalidad del documento (Proyecto)", helper: "¿El documento en su totalidad cumple con el formato establecido para márgenes, títulos, subtítulos, interlineado, tipo, estilo y tamaño de letra, así como la identificación de la portada, página preliminar, tablas, cuadros y figuras?", section: "Diagramacion", subsection: "General", documentType: 'Proyecto', answerType: 'yesno' },
  { id: "q72", label: "D.3 - Reglas ortográficas (Proyecto)", helper: "¿En la totalidad del documento se cumple con cada una de las reglas ortográficas?", section: "Diagramacion", subsection: "General", documentType: 'Proyecto', answerType: 'yesno' },
  { id: "q73", label: "D.4 - Redacción y coherencia (Proyecto)", helper: "¿La redacción del documento presenta un lenguaje coherente, claro, técnicamente adecuado y organizado, y hay transiciones claras entre los párrafos y las secciones del texto?", section: "Diagramacion", subsection: "General", documentType: 'Proyecto', answerType: 'yesno' },

  // Diagramacion - General aggregated checks for Tesis (same wording but separated tipo)
  { id: "q74", label: "D.1 - Elementos preliminares (Tesis)", helper: "¿El documento cuenta con portada, página de presentación, carta de aprobación del tutor (firmada), declaración de derecho de autor, índice general, índices específicos (si aplica), lista de símbolos y abreviaturas (si aplica) y glosario de términos (si aplica)?", section: "Diagramacion", subsection: "General", documentType: 'Tesis', answerType: 'yesno' },
  { id: "q75", label: "D.2 - Formato en la totalidad del documento (Tesis)", helper: "¿El documento en su totalidad cumple con el formato establecido para márgenes, títulos, subtítulos, interlineado, tipo, estilo y tamaño de letra, así como la identificación de la portada, página preliminar, tablas, cuadros y figuras?", section: "Diagramacion", subsection: "General", documentType: 'Tesis', answerType: 'yesno' },
  { id: "q76", label: "D.3 - Reglas ortográficas (Tesis)", helper: "¿En la totalidad del documento se cumple con cada una de las reglas ortográficas?", section: "Diagramacion", subsection: "General", documentType: 'Tesis', answerType: 'yesno' },
  { id: "q77", label: "D.4 - Redacción y coherencia (Tesis)", helper: "¿La redacción del documento presenta un lenguaje coherente, claro, técnicamente adecuado y organizado, y hay transiciones claras entre los párrafos y las secciones del texto?", section: "Diagramacion", subsection: "General", documentType: 'Tesis', answerType: 'yesno' },
  ...
  // Contenido (Tesis) — duplicate set with robust checks for thesis
  { id: "q57", label: "Título (Tesis) - Claridad y concisión", helper: "Describe el contenido del trabajo de manera clara, concisa, y no excede de quince (15) palabras.", section: "Contenido", subsection: "Título", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q58", label: "Título (Tesis) - Precisión de variables/categorías", helper: "Contiene los términos precisos de las variables (para estudios cuantitativos) o categorías (para estudios cualitativos) esenciales.", section: "Contenido", subsection: "Título", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q59", label: "Subtítulo (Tesis) - Complemento del título", helper: "Complementa el título proporcionando información adicional para precisar el alcance o enfoque de la investigación.", section: "Contenido", subsection: "Subtítulo", documentType: 'Tesis', answerType: 'frequency' },

  // Contenido → Capítulo 1. Introducción (Tesis) → 1.1 Planteamiento del Problema (10 questions)
  { id: "q60", label: "1.1 - Planteamiento: formulación y evidencias", helper: "¿El planteamiento del problema está formulado de manera clara y estructurada, y se proporcionan evidencias del mismo?", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q61", label: "1.1 - Planteamiento: general a particular y causas", helper: "¿El planteamiento del problema se realiza desde lo general a lo particular, y se identifican y/o describen las causas que lo originan?", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q62", label: "1.1 - Importancia", helper: "¿Se explican las razones por las cuales es importante llevar a cabo la investigación?", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q63", label: "1.1 - Aporte social y científico", helper: "¿Se argumenta sobre el aporte de la investigación al campo de conocimiento, y a la sociedad?", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q64", label: "1.1 - Objetivo general único y delimitado", helper: "¿El objetivo general es único, describe de manera clara y coherente lo que se pretende lograr en la investigación a modo general, delimitándola adecuadamente?", section: "Contenido", subsection: "1.4.1 Objetivo General", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q65", label: "1.1 - Verbo en infinitivo y nivel de Bloom", helper: "¿El verbo empleado en el objetivo general está en infinitivo, es acorde con el nivel de la investigación, y pertenece a un nivel de aplicación adecuado (al menos tercero de la taxonomía de Bloom)?", section: "Contenido", subsection: "1.4.1 Objetivo General", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q66", label: "1.1 - Objetivos específicos 3-5 y verbos en infinitivo", helper: "¿Se documentan entre tres y cinco objetivos específicos, los verbos empleados están en infinitivo, y acordes con el nivel de aplicación del objetivo general?", section: "Contenido", subsection: "1.4.2 Objetivos Específicos", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q67", label: "1.1 - Objetivos específicos: medibles y observables", helper: "¿Los objetivos específicos describen de manera clara, coherente y en orden lógico los logros intermedios medibles y observables que permiten la consecución del objetivo general?", section: "Contenido", subsection: "1.4.2 Objetivos Específicos", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q68", label: "1.1 - Operacionalización: definición de variables", helper: "¿Cada una de las variables de la investigación indicada en su operacionalización, cuenta con una definición clara y precisa del concepto que se está estudiando en el contexto del trabajo?", section: "Contenido", subsection: "Operacionalización de variables", documentType: 'Tesis', answerType: 'frequency' },
  { id: "q69", label: "1.1 - Operacionalización: dimensiones, indicadores, subindicadores", helper: "¿En la operacionalización de variables, las dimensiones asociadas con cada variable corresponden a características de las mismas, y los indícadores y subindicadores planteados proporcionan datos concretos sobre las dimensiones y son coherentes, adecuados, observables y cuantificables?", section: "Contenido", subsection: "Operacionalización de variables", documentType: 'Tesis', answerType: 'frequency' },
