...
// 3-option scale for Thesis questions (Sí/Medianamente/No)
export const TERNARY_OPTIONS = [
  { value: 1, label: 'No', color: 'bg-red-100 text-red-700 border-red-300' },
...
// 5-option scale for q76 (includes "No hay subtítulo" and "No se incluyó")
export const TERNARY_NA_OPTIONS = [
  { value: 1, label: 'No', color: 'bg-red-100 text-red-700 border-red-300' },
  { value: 2, label: 'Medianamente', color: 'bg-yellow-100 text-yellow-700 border-yellow-300' },
  { value: 3, label: 'Sí', color: 'bg-green-100 text-green-700 border-green-300' },
  { value: 4, label: 'No se incluyó información', color: 'bg-red-100 text-red-700 border-red-300' },
  { value: 5, label: 'No hay subtítulo, pero no lo requiere', color: 'bg-blue-100 text-blue-700 border-blue-300' },
];

// 4-option scale (Sí/Medianamente/No/No se incluyó)
export const TERNARY_INFO_OPTIONS = [
  { value: 1, label: 'No', color: 'bg-red-100 text-red-700 border-red-300' },
  { value: 2, label: 'Medianamente', color: 'bg-yellow-100 text-yellow-700 border-yellow-300' },
  { value: 3, label: 'Sí', color: 'bg-green-100 text-green-700 border-green-300' },
  { value: 4, label: 'No se incluyó información', color: 'bg-red-100 text-red-700 border-red-300' },
...
// CONTENIDO section scoring (28 questions, 15 points total max)
...
// TESIS DIAGRAMACIÓN section scoring (14 questions, ~2 points total -> ~0.1428 per question)
export const TESIS_DIAGRAMACION_SCORES = {
  ternary: {
    yes: 0.1429,          // Sí
    medianamente: 0.0714, // Medianamente
    no: 0.01,             // No
  },
  yesno: {
    yes: 0.1429,    // Sí
...
// TESIS CONTENIDO section scoring (24 questions, 18 points total target -> 0.75 per question)
export const TESIS_CONTENIDO_SCORES = {
  ternary: {
    yes: 0.75,          // Sí
    medianamente: 0.05, // Medianamente (Scaled approx from 0.06/0.90)
    no: 0.01,           // No
  },
  ternary_na: {
    yes: 0.75,          // Sí
    medianamente: 0.05, // Medianamente
    no: 0.01,           // No
    noseincluyo: 0.01,  // No se incluyó
    noaplica: 0.75,     // No hay subtítulo pero no lo requiere
  },
  ternary_info: {
    yes: 0.75,          // Sí
    medianamente: 0.05, // Medianamente
    no: 0.01,           // No
    noseincluyo: 0.01,  // No se incluyó information
  },
  yesno: {
    yes: 0.75,    // Sí
    no: 0.01,     // No
...
const _PROJECT_QUESTIONS: Question[] = [
  // Diagramacion → Portada (Both) - Weight: DIAGRAMACION_WEIGHT (5/28 ≈ 0.1785)
  { id: "q1", label: "Logo Universidad", helper: "Contiene a 3 cm del borde superior y de manera centrada el logo de la universidad en negro o azul (3,5 cm *1,3 cm)", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT, relatedImage: "https://via.placeholder.com/600x400/e2e8f0/475569?text=Ejemplo+Logo+Universidad" },
  { id: "q2", label: "Nombre de la Universidad", helper: "Inmediatamente debajo del Logo de la universidad, y separados por 0,5 cm; se encuentra el nombre de la misma en letra Arial tamaño", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT, relatedImage: "https://via.placeholder.com/600x400/e2e8f0/475569?text=Ejemplo+Nombre+Universidad" },
  { id: "q3", label: "Nombre de la Facultad", helper: "Inmediatamente debajo del nombre de la universidad, y separados por 0,5 cm; se encuentra el nombre de la Facultad en letra Arial tamaño", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q4", label: "Título de la investigación", helper: "El título de la investigación está mayúscula y negrillas, centrado horizontal y verticalmente, con interlineado sencillo y en letra Verdana Tamaño 14", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT, relatedImage: "https://via.placeholder.com/600x400/e2e8f0/475569?text=Ejemplo+Titulo" },
  { id: "q5", label: "Subtítulo de la investigación", helper: "En caso de existir subtítulo de la investigación, el mismo está mayúscula y negrillas, centrado horizontal y verticalmente, con interlineado sencillo, separado del título por espacio y medio; y en letra Verdana Tamaño 12", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q6", label: "Nombre del autor", helper: "El nombre del autor o autores y sus cédulas de identidad aparecen alineados a la derecha, en letra Verdana tamaño 12, e interlineado sencillo; precedido por la palabra Autor o Autores en negrillas, separada del primer autor por espacio y medio", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q7", label: "Ciudad y fecha", helper: "Aproximadamente a 3 cm del borde inferior de la hoja se encuentra la ciudad donde se realizó el trabajo, el mes y el año, centrados y en Verdana tamaño 12", section: "Diagramacion", subsection: "Portada", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },

  // Diagramacion → Página de Presentación (Both)
  { id: "q8", label: "Logo Universidad", helper: "Contiene a 3 cm del borde superior y de manera centrada el logo de la universidad en negro o azul (3,5 cm *1,3 cm)", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q9", label: "Nombre de la Universidad", helper: "Inmediatamente debajo del Logo de la universidad, y separados por 0,5 cm; se encuentra el nombre de la misma en letra Arial tamaño", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q10", label: "Nombre de la Facultad", helper: "Inmediatamente debajo del nombre de la universidad, y separados por 0,5 cm; se encuentra el nombre de la Facultad en letra Arial tamaño", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q11", label: "Título de la investigación", helper: "El título de la investigación está mayúscula y negrillas, centrado horizontal y verticalmente, con interlineado sencillo y en letra Verdana Tamaño 14", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q12", label: "Subtítulo de la investigación", helper: "En caso de existir subtítulo de la investigación, el mismo está mayúscula y negrillas, centrado horizontal y verticalmente, con interlineado sencillo, separado del título por espacio y medio (aproximadamente 0,8 cm); y en letra Verdana Tamaño 12", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q13", label: "Línea de Investigación", helper: "Inmediatamente debajo del Título (o subtítulo) y separada del mismo por espacio y medio (aproximadamente 0,8 cm) se indica la Línea de Investigación Rectora y Potencial, en Verdana tamaño 12, con sus primeras letras en mayúsculas, centrado, en Verdana tamaño 12", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q14", label: "Nombre del autor (derecha)", helper: "El nombre del autor o autores y sus cédulas de identidad aparecen alineados a la derecha, en letra Verdana tamaño 12, e interlineado sencillo; precedido por la palabra Autor o Autores en negrillas, separada del primer autor por espacio y medio", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q15", label: "Nombre del tutor (izquierda)", helper: "El nombre del tutor o tutores y sus cédulas de identidad aparecen alineados a la izquierda, en letra Verdana tamaño 12, e interlineado sencillo; precedido por la palabra Tutor o Tutores en negrillas, separada del primer tutor por espacio y medio", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q16", label: "Ciudad y fecha", helper: "Aproximadamente a 3 cm del borde inferior de la hoja se encuentra la ciudad donde se realizó el trabajo, el mes y el año, centrados y en Verdana tamaño 12", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q17", label: "Carta de aprobación del tutor", helper: "El trabajo contiene la carta de aprobación del tutor", section: "Diagramacion", subsection: "Página de Presentación", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },

  // Diagramacion → Capítulo 1. Introducción (Both)
  { id: "q18", label: "Extensión máxima", helper: "Tiene una extensión máxima de 10 páginas", section: "Diagramacion", subsection: "Capítulo 1: Introducción", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q19", label: "Título del capítulo", helper: "El título: CAPÍTULO 1. INTRODUCCIÓN se encuentra al borde del margen izquierdo de la hoja; en negrillas; mayúsculas y en Verdana 14", section: "Diagramacion", subsection: "Capítulo 1: Introducción", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q20", label: "Subtítulos del capítulo", helper: "Los subtítulos: 1.1. Planteamiento del problema; 1.2 Justificación e impacto de la Investigación; 1.3 Interrogantes de la Investigación; 1.4 Objetivos de la Investigación; 1.4.1. Objetivo General; y 1.4.2. Objetivos específicos; se encuentran al borde del margen izquierdo de la hoja; en negrillas; en mayúscula la primera letra de la primera palabra y la primera letra de cada palabra principal; y en Verdana 12", section: "Diagramacion", subsection: "Capítulo 1: Introducción", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },

  // Diagramacion → Formato General (Both)
  { id: "q21", label: "Márgenes de página", helper: "En todas las páginas, el margen izquierdo es de cuatro (4) centímetros; mientras que el margen inferior, el margen superior y el margen derecho deben ser de tres (3) centímetros desde el borde de la hoja", section: "Diagramacion", subsection: "Formato General", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  { id: "q22", label: "Interlineado en párrafos", helper: "En todos los párrafos del cuerpo del documento el interlineado es de espacio y medio (1,5 líneas) agregando una separación de media línea (6 puntos) entre párrafo y párrafo; entre título y subtítulo; entre dos subtítulos y entre el párrafo las tablas o cuadros", section: "Diagramacion", subsection: "Formato General", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },
  ...
  { id: "q28", label: "Formato APA", helper: "En la lista de referencias siempre se especifica la información en formato APA", section: "Diagramacion", subsection: "Referencias Bibliográficas", documentType: 'Both', answerType: 'yesno', weight: DIAGRAMACION_WEIGHT },

  // Contenido → Título (Proyecto) - Weight: CONTENIDO_WEIGHT (15/28 ≈ 0.5357)
  { id: "q29", label: "Título - Claridad y concisión", helper: "Describe el contenido del trabajo de manera clara, concisa, y no excede de quince (15) palabras.", section: "Contenido", subsection: "Título", documentType: 'Proyecto', answerType: 'frequency', weight: CONTENIDO_WEIGHT },
  ...
  { id: "q36", label: "Planteamiento - Efectos/impactos no deseados", helper: "En el planteamiento se mencionan los efectos y/o impactos no deseados del problema.", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Proyecto', answerType: 'frequency', weight: CONTENIDO_WEIGHT },
  { id: "q37", label: "Planteamiento - Proyecciones/pronósticos", helper: "En el planteamiento se incluyen proyecciones o pronósticos de las variables involucradas en la situación problemática.", section: "Contenido", subsection: "1.1 Planteamiento del problema", documentType: 'Proyecto', answerType: 'frequency', weight: CONTENIDO_WEIGHT },
  ...
  { id: "q44", label: "Interrogantes - Límites temporales y espaciales", helper: "Establecen los límites temporales y espaciales del estudio.", section: "Contenido", subsection: "1.3 Interrogantes de la investigación", documentType: 'Proyecto', answerType: 'frequency', weight: CONTENIDO_WEIGHT },
  ...
  { id: "q54", label: "Objetivos Específicos - Niveles inferiores", helper: "Tener niveles inferiores al nivel de la taxonomía de Bloom en que se ubica el objetivo general.", section: "Contenido", subsection: "1.4.2 Objetivos Específicos", documentType: 'Proyecto', answerType: 'frequency', weight: CONTENIDO_WEIGHT },
...
const _TESIS_STAGE1_QUESTIONS: Question[] = [
  // 3. Diagramación (yesno=0.14/0.01, ternary=0.14/0.07/0.01)
  // Questions 1-9: yesno (Sí, No)
  ...
  { id: "q60", label: "Leyenda del Título", helper: "¿Aparece debajo del título la leyenda \"Trabajo Especial de Grado presentado como requisito...\" con el formato correcto?", section: "Diagramación", subsection: "Formato", documentType: 'Tesis', answerType: 'yesno' },
  { id: "q65", label: "Formato de Autores", helper: "¿Están los nombres con el formato correcto (primer nombre, primer apellido, alineados, Verdana 12)?", section: "Diagramación", subsection: "Formato", documentType: 'Tesis', answerType: 'yesno' },
  { id: "q66", label: "Ciudad y Fecha", helper: "¿Se encuentra la ciudad, mes y año con el formato correcto?", section: "Diagramación", subsection: "Formato", documentType: 'Tesis', answerType: 'yesno' },
  ...
  { id: "q69", label: "Palabras Clave", helper: "¿Hay un máximo de seis términos, ordenados alfabéticamente?", section: "Diagramación", subsection: "Resumen", documentType: 'Tesis', answerType: 'yesno' },
  // Question 10: ternary (Sí, Medianamente, No)
  { id: "q70", label: "Pertinencia de Palabras Clave", helper: "¿Considera que los términos describen adecuadamente los aspectos relevantes de la investigación?", section: "Diagramación", subsection: "Resumen", documentType: 'Tesis', answerType: 'ternary' },
  // Question 11: yesno
  ...
  // Questions 12-13: ternary (Sí, Medianamente, No)
  { id: "q72", label: "Redacción", helper: "¿Es fluida, clara, concisa y comprensible?", section: "Diagramación", subsection: "Resumen", documentType: 'Tesis', answerType: 'ternary' },
  { id: "q73", label: "Gramática", helper: "¿Es adecuada (tiempos verbales en pasado, coherencia de género y número)?", section: "Diagramación", subsection: "Resumen", documentType: 'Tesis', answerType: 'ternary' },
  // Question 14: yesno
  ...
  { id: "q75", label: "Título - Claridad y precisión", helper: "¿El título describe el contenido de manera clara y concisa?", section: "Contenido, Congruencia y Coherencia", subsection: "Título y Subtítulo", documentType: 'Tesis', answerType: 'ternary' },
  { id: "q76", label: "Subtítulo - Complemento", helper: "¿El subtítulo complementa al título proporcionando información adicional para precisar el alcance?", section: "Contenido, Congruencia y Coherencia", subsection: "Título y Subtítulo", documentType: 'Tesis', answerType: 'ternary_na' },

  // B. Planteamiento del Problema
  { id: "q77", label: "Planteamiento - Claridad", helper: "¿Está formulado de manera clara y estructurada?", section: "Contenido, Congruencia y Coherencia", subsection: "Planteamiento del Problema", documentType: 'Tesis', answerType: 'ternary_info' },
  
  // C. Justificación
  { id: "q79", label: "Justificación", helper: "¿Se expone de manera clara la justificación y/o importancia de la investigación?", section: "Contenido, Congruencia y Coherencia", subsection: "Justificación", documentType: 'Tesis', answerType: 'ternary_info' },

  // D. Objetivo General
  { id: "q80", label: "Objetivo General - Precisión", helper: "¿Está formulado con precisión, claridad y delimita adecuadamente el problema?", section: "Contenido, Congruencia y Coherencia", subsection: "Objetivo General", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q80b", label: "Objetivo General - Coherencia", helper: "¿Es coherente con el planteamiento del problema?", section: "Contenido, Congruencia y Coherencia", subsection: "Objetivo General", documentType: 'Tesis', answerType: 'ternary_info' },

  // E. Clasificación de la Investigación (Tipos de Investigación)
  { id: "q81", label: "Clasificación - Propósito", helper: "¿Se especifica si según su propósito fundamental es de tipo pura o aplicada?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q82", label: "Clasificación - Enfoque", helper: "¿Se especifica si según el enfoque del paradigma metodológico es de tipo: cualitativa, cuantitativa, mixta...?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q83", label: "Clasificación - Diseño", helper: "¿Se especifica si según la forma de recolectar la información su diseño es: documental, experimental...?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q84", label: "Clasificación - Alcance Temporal", helper: "¿Se especifica si según el alcance temporal del estudio su diseño es: longitudinal o transaccional?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q85", label: "Clasificación - Nivel de Análisis", helper: "¿Se especifica si según el nivel de profundidad del análisis es: exploratoria, descriptiva, comparativa...?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q86", label: "Clasificación - Proyecto Factible", helper: "¿Se especifica si dependiendo del enfoque con que se realiza es una investigación o un proyecto factible?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q87", label: "Clasificación - Congruencia", helper: "¿La clasificación de la investigación es adecuada y congruente con el objetivo de la misma?", section: "Contenido, Congruencia y Coherencia", subsection: "Clasificación de la Investigación", documentType: 'Tesis', answerType: 'ternary_info' },

  // F. Muestra
  { id: "q88", label: "Muestra", helper: "¿En el texto se especifica la muestra empleada en la investigación?", section: "Contenido, Congruencia y Coherencia", subsection: "Muestra", documentType: 'Tesis', answerType: 'ternary' },

  // G. Técnicas, Métodos y Procedimientos
  { id: "q89", label: "Técnicas - Descripción", helper: "¿Su descripción es clara y precisa?", section: "Contenido, Congruencia y Coherencia", subsection: "Técnicas, Métodos y Procedimientos", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q89b", label: "Técnicas - Coherencia", helper: "¿Son adecuadas y coherentes con el objetivo general?", section: "Contenido, Congruencia y Coherencia", subsection: "Técnicas, Métodos y Procedimientos", documentType: 'Tesis', answerType: 'ternary_info' },

  // H. Resultados Principales
  { id: "q90", label: "Resultados - Claridad", helper: "¿Están expresados de manera clara y acompañados de valores cuantitativos?", section: "Contenido, Congruencia y Coherencia", subsection: "Resultados Principales", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q91", label: "Resultados - Significancia", helper: "¿Se expresa la significancia estadística de los resultados principales de manera adecuada?", section: "Contenido, Congruencia y Coherencia", subsection: "Resultados Principales", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q92", label: "Resultados - Coherencia", helper: "¿Son coherentes y adecuados con las técnicas, métodos, procedimientos experimentales empleados?", section: "Contenido, Congruencia y Coherencia", subsection: "Resultados Principales", documentType: 'Tesis', answerType: 'ternary_info' },

  // I. Análisis de Resultados y Conclusiones
  { id: "q93", label: "Análisis - Presentación", helper: "¿Están claramente presentadas?", section: "Contenido, Congruencia y Coherencia", subsection: "Análisis y Conclusiones", documentType: 'Tesis', answerType: 'ternary_info' },
  { id: "q94", label: "Análisis - Coherencia Objetivos", helper: "¿Son coherentes y adecuadas con el objetivo general?", section: "Contenido, Congruencia y Coherencia", subsection: "Análisis y Conclusiones", documentType: 'Tesis', answerType: 'ternary' },
  { id: "q95", label: "Análisis - Coherencia Métodos", helper: "¿Son coherentes y adecuadas con las técnicas/métodos empleados?", section: "Contenido, Congruencia y Coherencia", subsection: "Análisis y Conclusiones", documentType: 'Tesis', answerType: 'ternary' },
  ...
  { id: "q97", label: "Ecuaciones", helper: "¿Las ecuaciones, incluidas en el resumen son necesarias?", section: "Contenido, Congruencia y Coherencia", subsection: "Elementos Gráficos y Matemáticos", documentType: 'Tesis', answerType: 'yesno' },
