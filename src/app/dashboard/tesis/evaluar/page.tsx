...
export default function EvaluarTesisPage({
  ...
  const toggleStage1Pass = () => {
    ...
    if (projectId) {
      sessionStorage.setItem(`project_${projectId}_stage1_passed`, String(newState));
    }
  };
  ...
  return (
    <>
      <DashboardHeader
        pageTitle={`Evaluar Tesis - Selección de Fase`}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                El proceso de evaluación de Tesis consta de dos fases secuenciales.
                La Fase 2 solo estará disponible una vez aprobada la Fase 1.
              </p>
              
              {/* Demo Control */}
              <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg inline-block">
                <p className="text-xs font-bold text-yellow-800 uppercase mb-2">Control de Demo</p>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-yellow-900">Simular Fase 1 Aprobada</span>
                </label>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* Fase 1 Card */}
              <div 
                onClick={() => router.push(`/dashboard/tesis/evaluar/fase1?projectId=${projectId}`)}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Fase 1: Diagramación</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Evaluación de aspectos formales, estructura, ortografía y cumplimiento de normas de presentación.
                </p>
              ...
              <div 
                onClick={() => {
                    ...
                    router.push(`/dashboard/tesis/evaluar/fase2?projectId=${projectId}`);
                }}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Fase 2: Contenido</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Evaluación del planteamiento, objetivos, marco teórico, metodología y resultados.
                </p>
                <div className={`flex items-center text-sm font-medium ${
                  stage1Passed ? 'text-green-600' : 'text-gray-400'
                }`}>
                  {stage1Passed ? 'Evaluar ahora →' : 'Bloqueado (Requiere Fase 1)'}
                </div>
              </div>
            </div>
          </div>
